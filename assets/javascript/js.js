$(document).ready(function() {
    ...
    // my array
    var topic = ["Beyonce", "Taylor Swift", "Rihanna", "Betty White", "Whitney Houston", "Tyra Banks", "Oprah Winfrey", "Kim Kardashian", "Celin Dion"];
    ...
    function displayGifs() {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + lady + "&api_key=dc6zaTOxFJmzC&limit=10";
